...
def test_darknode_registration_happy_path(owner, node_operator, ren_pool, ren_token):
    """
    ...
    ren_pool.registerDarknode(base58_to_hex(NODE_ID), PUBLIC_KEY, {'from': node_operator}) # NodeID converted to Hexadecimal
